...
import svgPaths from "../imports/svg-lpg89bl61u";
        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-white border border-gray-200 rounded-3xl p-6 shadow-sm">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input
                    ...
                    className="pl-10 pr-4 py-3 rounded-full border-gray-300 focus:border-black focus:ring-black"
                    required
                  />
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input
                    ...
                    className="pl-10 pr-12 py-3 rounded-full border-gray-300 focus:border-black focus:ring-black"
                    required
                  />
                  ...
                  <Button
                    ...
                    variant="ghost"
                    size="sm"
                    className="absolute right-3 top-1/2 transform -translate-y-1/2 w-6 h-6 p-0"
            ...
            <Button
              type="button"
              variant="outline"
              className="w-full border-gray-300 rounded-full py-3 font-medium hover:bg-gray-50 transition-colors"
