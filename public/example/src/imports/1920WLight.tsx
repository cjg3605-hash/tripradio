import svgPaths from "./svg-gggyn7ftv2";
...
export default function Component1920WLight() {
  return (
    <div
      className="bg-[#ffffff] box-border content-stretch flex flex-col isolate items-start justify-start p-0 relative size-full"
