...
import SoftwareApplicationSchema from '../src/components/seo/SoftwareApplicationSchema';
import ServiceSchema from '../src/components/seo/ServiceSchema';
import ReviewSchema from '../src/components/seo/ReviewSchema';
import Script from 'next/script';
import { cookies } from 'next/headers';
import { detectPreferredLanguage, LANGUAGE_COOKIE_NAME } from '../src/lib/utils';
  ...
  return (
    <html lang={serverLanguage} suppressHydrationWarning>
      <head>
        ...
        {/* Critical JavaScript Resources Prefetch - Only when needed */}
        {/* Leaflet resources moved to dynamic loading - removed to prevent unnecessary prefetch */}
        ...
        {/* Critical Fonts Preload - Inter Primary, Pretendard Secondary */}
        <link 
          rel="preload" 
        ...
        <link 
          rel="preload" 
          href="https://fonts.gstatic.com/s/inter/v18/UcCO3FwrK3iLTeHuS_fvQtMwCp50KnMw2boKoduKmMEVuI6fAZ9hiJ-Ek-_EeA.woff2" 
          as="font" 
          type="font/woff2" 
          crossOrigin="anonymous"
        />
        {/* Medium weight는 필요시 lazy loading */}
      </head>
