...
function SignInContent() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-950 flex items-center justify-center relative overflow-hidden transition-colors duration-300">
      ...
      <ResponsiveContainer variant="narrow" className="relative z-10">
        ...
        <Link 
          href="/" 
          className="inline-flex items-center text-sm text-gray-400 dark:text-gray-500 hover:text-gray-600 dark:hover:text-gray-400 transition-colors duration-200 mb-8 group"
        >
        ...
        <div className="text-center mb-12">
          {/* Logo/Icon */}
          <div className="w-16 h-16 bg-black dark:bg-white rounded-lg flex items-center justify-center mx-auto mb-6 shadow-sm dark:shadow-lg transition-colors duration-300">
            {signupStep === 'email_verification' ? (
              ...
              <div className="w-8 h-8 bg-white dark:bg-black rounded-lg transition-colors duration-300"></div>
            )}
          </div>
          
          {/* Title */}
          <h1 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-3 tracking-tight transition-colors duration-300">
            {authMode === 'signup' 
              ? signupStep === 'completed' 
          ...
          {/* Subtitle */}
          {authMode === 'signup' && (
            <p className="text-gray-500 dark:text-gray-400 text-base leading-relaxed max-w-sm mx-auto transition-colors duration-300">
              {signupStep === 'email_verification'
                ? t('auth.enterCode')
                : signupStep === 'completed'
        ...
        {/* Main Card */}
        <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg shadow-sm dark:shadow-lg overflow-hidden transition-colors duration-300">
          {/* 회원가입 완료 상태 */}
          {authMode === 'signup' && signupStep === 'completed' && (
            <div className="p-12 text-center">
              ...
              <h3 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-4 transition-colors duration-300">회원가입 완료!</h3>
              ...
              <div className="space-y-4">
                ...
                <div className="w-16 h-1 bg-gray-200 dark:bg-gray-700 rounded-full mx-auto overflow-hidden transition-colors duration-300">
                  <div className="h-full bg-black dark:bg-white rounded-full animate-pulse transition-colors duration-300" style={{
          ...
          {authMode === 'signup' && signupStep === 'email_verification' && (
            <div className="p-8">
              <div className="text-center mb-8">
                ...
                <h3 className="text-xl font-bold text-gray-900 dark:text-gray-100 mb-3 transition-colors duration-300">이메일 인증</h3>
              ...
              {/* 6자리 인증 코드 입력 */}
              <div className="mb-8">
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-4 text-center transition-colors duration-300">
                  인증 코드 6자리를 입력하세요
                </label>
                    ...
                    <input
                      ...
                      className={`
                        ...
                        ${value 
                          ...
                          : 'border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-400 dark:text-gray-500 focus:border-blue-400 dark:focus:border-blue-500'
                        }
                        ${errors.verificationCode ? 'border-red-300 dark:border-red-500 bg-red-50 dark:bg-red-900/20' : ''}
                      `}
                      placeholder="•"
                    />
                  ))}
                ...
                {errors.verificationCode && (
                  <p className="text-red-600 dark:text-red-400 text-sm text-center flex items-center justify-center gap-2 transition-colors duration-300">
              ...
              <div className="text-center space-y-4">
                {countdown > 0 ? (
                  ...
                  <p className="text-red-600 dark:text-red-400 text-sm transition-colors duration-300">인증 코드가 만료되었습니다.</p>
                )}
              ...
              <div className="mt-8 pt-6 border-t border-gray-100">
                <button
                  ...
                  className="w-full text-sm text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 transition-colors flex items-center justify-center space-x-2"
                >
            ...
            <div className="p-8">
              <form onSubmit={handleSignIn} className="space-y-5">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`w-full pl-10 pr-4 py-3 border rounded-xl focus:outline-none focus:ring-2 focus:ring-black dark:focus:ring-white focus:border-transparent bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-400 transition-all duration-200 ${
                        errors.email ? 'border-red-300 dark:border-red-600 focus:ring-red-500' : 'border-gray-300 dark:border-gray-600'
                      }`}
                      placeholder={t('auth.enterYourEmail') as string}
                      autoComplete="email"
                    />
                  </div>
                  {errors.email && <p className="text-red-600 dark:text-red-400 text-sm mt-1 transition-colors duration-300">{errors.email}</p>}
                </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      onChange={handleInputChange}
                      className={`w-full pl-10 pr-12 py-3 border rounded-xl focus:outline-none focus:ring-2 focus:ring-black dark:focus:ring-white focus:border-transparent bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-400 transition-all duration-200 ${
                        errors.password ? 'border-red-300 dark:border-red-600 focus:ring-red-500' : 'border-gray-300 dark:border-gray-600'
                      }`}
                  ...
                  {errors.password && <p className="text-red-600 dark:text-red-400 text-sm mt-1 transition-colors duration-300">{errors.password}</p>}
                </div>
                ...
                <button
                  type="submit"
                  disabled={isLoading}
                  className="w-full bg-black dark:bg-white text-white dark:text-black py-3 px-4 rounded-xl font-medium hover:bg-gray-800 dark:hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-black dark:focus:ring-white focus:ring-offset-2 dark:focus:ring-offset-gray-900 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 flex items-center justify-center"
                >
                  {isLoading ? (
              ...
              <button
                ...
                disabled={isLoading}
                className="w-full flex items-center justify-center px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-xl shadow-sm text-sm font-medium text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-black dark:focus:ring-white focus:ring-offset-2 dark:focus:ring-offset-gray-900 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200"
              >
          ...
          {authMode === 'signup' && signupStep === 'form' && (
            <div className="p-8">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      onChange={handleInputChange}
                      className={`w-full pl-10 pr-4 py-3 border rounded-xl focus:outline-none focus:ring-2 focus:ring-black dark:focus:ring-white focus:border-transparent bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-400 transition-all duration-200 ${
                        errors.name ? 'border-red-300 dark:border-red-600 focus:ring-red-500' : 'border-gray-300 dark:border-gray-600'
                      }`}
                      placeholder={t('auth.enterYourName') as string}
                      autoComplete="name"
                    />
                  </div>
                  {errors.name && <p className="text-red-600 dark:text-red-400 text-sm mt-1 transition-colors duration-300">{errors.name}</p>}
                </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      onChange={handleInputChange}
                      className={`w-full pl-10 pr-12 py-3 border rounded-xl focus:outline-none focus:ring-2 focus:ring-black dark:focus:ring-white focus:border-transparent bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-400 transition-all duration-200 ${
                        errors.confirmPassword ? 'border-red-300 dark:border-red-600 focus:ring-red-500' : 'border-gray-300 dark:border-gray-600'
                      }`}
                  ...
                  {errors.confirmPassword && <p className="text-red-600 dark:text-red-400 text-sm mt-1 transition-colors duration-300">{errors.confirmPassword}</p>}
                </div>
              ...
              <div className="mt-6 pt-4 border-t border-gray-100 dark:border-gray-700">
                <p className="text-xs text-gray-500 dark:text-gray-400 text-center leading-relaxed transition-colors duration-300">
                  회원가입 시{' '}
        ...
        {/* Security Badge */}
        <div className="mt-6 flex items-center justify-center space-x-2 text-xs text-gray-400 dark:text-gray-500 transition-colors duration-300">
...
export default function SignInPage() {
  return (
    <Suspense fallback={
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-50 dark:from-gray-900 dark:via-gray-950 dark:to-gray-900 flex items-center justify-center transition-colors duration-300">
