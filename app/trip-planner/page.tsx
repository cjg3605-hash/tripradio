      ...
      <div className="bg-white dark:bg-gray-900 transition-colors duration-300">
        <div className="container mx-auto px-6 py-8">
          ...
          <div className="text-center mb-6">
            <div className="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-gray-100 dark:bg-gray-800 text-gray-800 dark:text-gray-200 mb-4 transition-colors duration-300">
              {String(t('tripPlanner.badge'))}
            </div>
            <h1 className="text-fluid-3xl font-normal text-black dark:text-white mb-4 leading-tight transition-colors duration-300">
              {String(t('tripPlanner.hero.title'))} <span className="font-semibold">{String(t('tripPlanner.hero.subtitle'))}</span>
            </h1>
            <p className="text-fluid-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto leading-relaxed transition-colors duration-300">
              {String(t('tripPlanner.hero.description'))}
            </p>
          </div>

          {/* Quick Planner Section */}
          <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-8 mb-16 transition-colors duration-300">
            <h2 className="text-fluid-2xl font-semibold text-black dark:text-white mb-6 text-center leading-snug transition-colors duration-300">
              <span dangerouslySetInnerHTML={{ __html: String(t('tripPlanner.quickPlanner.title')) }} />
            </h2>

            {/* Step 1: Travel Style Selection */}
            <div className="mb-8">
              <h3 className="text-fluid-xl font-semibold text-black dark:text-white mb-4 leading-snug transition-colors duration-300">{String(t('tripPlanner.steps.selectStyle'))}</h3>
            ...
            <div className="mb-8">
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <h3 className="text-fluid-xl font-semibold text-black dark:text-white mb-4 leading-snug transition-colors duration-300">{String(t('tripPlanner.steps.destinationDuration'))}</h3>
                  <div className="space-y-4">
                    <div>
                      <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2 transition-colors duration-300">{String(t('tripPlanner.form.destination.label'))}</label>
                      <input
                        type="text"
                        value={destination}
                    ...
                    <div>
                      <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2 transition-colors duration-300">{String(t('tripPlanner.form.departure'))}</label>
                      <input
                        type="date"
                        className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-black focus:border-transparent"
                      />
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl p-6 mb-6 border border-gray-200 dark:border-gray-700 transition-colors duration-300">
          ...
          {/* Saved Plans Display */}
          {showSavedPlans && (
            <div className="bg-white dark:bg-gray-800 rounded-lg p-8 mb-16 border border-gray-200 dark:border-gray-700 transition-colors duration-300">
