...
export const metadata: Metadata = {
  ...generateKeywordPageMetadata(
    '/trip-planner',
    'ko',
    'AI 여행 계획 도구 | 맞춤형 여행 일정 자동 생성 TripRadio.AI',
    '🗺️ AI가 당신의 취향과 예산에 맞춰 완벽한 여행 일정을 자동으로 생성합니다. 숙소, 교통, 관광지까지 한 번에 계획하세요',
    ['AI 여행 계획', '여행 일정 생성기', '맞춤형 여행 계획', '자동 여행 계획', '여행 플래너', '일정 관리', '여행 코스', 'AI 여행 플래너', 'TripRadio.AI']
  )
};
  ...
  return (
    <>
      <KeywordPageSchema 
        ...
        title="AI 여행 계획 도구 | 맞춤형 여행 일정 자동 생성 TripRadio.AI"
        description="AI가 당신의 취향과 예산에 맞춰 완벽한 여행 일정을 자동으로 생성합니다. 숙소, 교통, 관광지까지 한 번에 계획하세요"
        features={['AI 일정 생성', '실시간 추천', '예산 관리', '맞춤형 코스', '현지 정보', '완전 무료']}
      />
