...
if (missingEnvVars.length > 0) {
  ...
  missingEnvVars.forEach(envVar => {
    if (envVar === 'NEXT_PUBLIC_BASE_URL') {
      console.log(`   ${envVar}=https://navi-guide-ai-eight.vercel.app`);
...
<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">
  <url>
    <loc>https://navi-guide-ai-eight.vercel.app/</loc>
    <lastmod>${new Date().toISOString()}</lastmod>
    <changefreq>weekly</changefreq>
    <priority>1.0</priority>
  </url>
  <url>
    <loc>https://navi-guide-ai-eight.vercel.app/legal/privacy</loc>
    <lastmod>${new Date().toISOString()}</lastmod>
    <changefreq>monthly</changefreq>
    <priority>0.8</priority>
  </url>
  <url>
    <loc>https://navi-guide-ai-eight.vercel.app/legal/terms</loc>
    <lastmod>${new Date().toISOString()}</lastmod>
    <changefreq>monthly</changefreq>
    <priority>0.8</priority>
  </url>
  <url>
    <loc>https://navi-guide-ai-eight.vercel.app/legal/about</loc>
    <lastmod>${new Date().toISOString()}</lastmod>
    <changefreq>monthly</changefreq>
    <priority>0.8</priority>
  </url>
  <url>
    <loc>https://navi-guide-ai-eight.vercel.app/legal/contact</loc>
    <lastmod>${new Date().toISOString()}</lastmod>
    <changefreq>monthly</changefreq>
    <priority>0.8</priority>
  </url>
...
Sitemap: https://navi-guide-ai-eight.vercel.app/sitemap.xml
