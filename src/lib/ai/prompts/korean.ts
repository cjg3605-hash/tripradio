  ...
  content: {
    ...
    route: {
      steps: [
        ...
        { step: 4, location: "궁중정원", title: "경복궁 궁중정원" },
        { step: 5, location: "국립고궁박물관", title: "국립고궁박물관" }
      ]
    },
    realTimeGuide: {
      chapters: [
        ...
        },
        {
          id: 1,
          title: "경복궁 근정전",
          narrative: "근정전은 경복궁의 중심 건물로, 조선왕조의 정전입니다. '근정'은 부지런히 정사를 본다는 뜻으로, 이곳에서 왕이 신하들과 조회를 열고 국정을 논의했습니다. 2층 월대 위에 세워진 근정전은 다포계 양식의 대표작으로, 24개의 기둥이 건물을 떠받치고 있습니다. 내부의 용상과 일월오봉도는 왕권의 상징으로, 천자를 뜻하는 황금 용 조각이 천장을 장식합니다.",
          nextDirection: "근정전 관람을 마치시고, 이제 서쪽으로 향해 경회루로 이동해보겠습니다. 약 300미터 거리입니다."
        },
        {
          id: 2,
          title: "경복궁 경회루",
          narrative: "경회루는 경복궁 서쪽에 위치한 누각으로, 연못 위에 세워진 아름다운 건축물입니다. '경회'는 '기쁨을 함께 한다'는 뜻으로, 왕이 신하들과 연회를 베풀던 곳입니다. 48개의 돌기둥으로 떠받친 2층 누각은 조선 전기 목조건축의 걸작으로 평가됩니다. 연못에는 취향교라는 다리가 있어 경회루까지 연결되며, 사계절 내내 다른 아름다움을 선사합니다.",
          nextDirection: "경회루의 아름다움을 충분히 감상하셨다면, 이제 동쪽 궁중정원으로 이동해보겠습니다."
        }
      ]
    }
  }
...
### 6. **📍 좌표 자동 처리**
**좌표는 시스템에서 자동으로 정확하게 추가됩니다. AI는 좌표 관련 내용을 작성하지 마세요.**
...
**🚨 최종 확인사항:**
- 모든 챕터 제목은 "장소명만" 형태여야 합니다 (콜론과 설명 없이)
...
5. **📍 좌표 시스템 처리**: AI는 좌표 작성하지 않음 (시스템 자동 추가)
