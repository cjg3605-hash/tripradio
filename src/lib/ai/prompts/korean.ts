...
#### ✅ **올바른 정보 배치**
- **1챕터**: 전체 역사적 배경 (창건, 복원, 주요 사건)
- **2챕터 이후**: 각 건물만의 고유한 특징, 기능, 특별한 이야기

#### ❌ **절대 금지 - 반복 패턴**
잘못된 예시:
• 1챕터: "창경궁은 1484년 창건되어 임진왜란 때 소실되었다가 1604년 복원되었습니다"
• 2챕터: "홍화문은 1484년 창경궁과 함께 건립되어..." ← 🚫 중복!
• 3챕터: "명정전도 1484년에 건립되었다가 임진왜란 때..." ← 🚫 중복!

#### ✅ **올바른 예시**
• 1챕터: "창경궁은 1484년(성종 15년) 창건되어 임진왜란으로 소실된 후 1604년 복원"
• 2챕터: "홍화문의 독특한 건축 양식과 문 장식의 의미" ← ✅ 고유 특징!  
• 3챕터: "명정전의 어좌와 천장 문양, 정치적 기능" ← ✅ 개별 특성!
...
- **coordinates**: 각 챕터마다 실제 위치의 정확한 GPS 좌표 (lat, lng, description)
- **좌표 정확성**: 실제 관광지의 정확한 위치 정보 제공
- **위치별 정확성**: 에펠탑이면 파리 좌표, 스핑크스면 이집트 좌표 등 실제 위치 반영

**📏 좌표 작성 원칙:**
- **lat**: 위도 (소수점 4자리까지 정확히)
- **lng**: 경도 (소수점 4자리까지 정확히)  
- **description**: 해당 좌표 지점의 구체적 위치 설명

**🚨 좌표 예시:**
"coordinates": {
  "lat": 48.8584,
  "lng": 2.2945,
  "description": "에펠탑 1층 입구"
}
