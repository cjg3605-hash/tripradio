...
**✅ 좋은 예시 (자연스럽고 몰입감 있음)**:
- sceneDescription: "자, 여러분! 지금 우리 앞에 우뚝 서 있는 이 웅장한 문이 바로 광화문입니다. 와, 정말 크죠? 높이가 무려 20미터나 된답니다. 저 화려한 단청 좀 보세요! 빨강, 파랑, 초록이 햇빛을 받아 반짝이는 모습이 정말 아름답지 않나요? 그런데 말이죠, 이 광화문이 왜 이렇게 크고 화려하게 지어졌는지 궁금하지 않으세요?"
- coreNarrative: "아, 그건 바로 이 문이 단순한 출입구가 아니었기 때문이에요! 1395년, 조선을 건국한 태조 이성계가 새 왕조의 이상을 이 문에 담았거든요. '광화'라는 이름 자체가 '왕의 덕으로 온 나라를 밝게 비춘다'는 뜻이니까요. 하지만 이 문도 우리 역사처럼 참 파란만장한 삶을 살았어요. 일제강점기 때는 일본이 이 문을 강제로 옮겨버렸고, 6.25 전쟁 때는 폭격으로 불타 없어지기도 했죠. 그런데 2010년 복원 공사 때 정말 놀라운 일이 일어났답니다..."
- humanStories: "네, 바로 그 이야기인데요! 복원 공사를 하던 중에 한 70대 석공 장인이 찾아왔어요. 그런데 이분의 할아버지가 일제강점기 때 광화문을 강제로 이전하는 작업에 참여했던 분이래요. 그 할아버지는 평생 그 일을 가슴 아파하시다가 손자에게 '언젠가 광화문이 제자리로 돌아가면 꼭 도와달라'고 유언을 남기셨대요. 그래서 이 장인은 무보수로 복원 작업에 참여해서 3대에 걸친 한을 풀었다는 거예요. 정말 가슴 뭉클하지 않나요? 자, 이런 감동적인 이야기를 품은 광화문을 지나 이제 다음으로 가볼까요?"
...
절대로 독립적인 섹션이 아닙니다! 
한 사람이 현장에서 관광객들에게 10분간 쉬지 않고 이야기하는 것처럼,
각 필드의 끝과 시작이 매끄럽게 연결되어야 합니다.
필드 사이에 주제가 갑자기 바뀌거나 새로운 이야기가 시작되면 안 됩니다!
