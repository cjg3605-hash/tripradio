...
- sceneDescription: "광화문을 감상하기 전에 먼저 알아두시면 좋을 배경지식이 있어요. 조선시대 궁궐 정문은 단순한 출입구가 아니라 왕조의 철학과 이상을 담은 상징물이었습니다. 특히 '광화(光化)'라는 이름은 '빛으로 교화한다'는 뜻으로, 왕의 덕치로 백성을 밝게 이끈다는 유교적 정치 이념을 표현한 거죠. 또한 궁문의 크기와 장식은 왕조의 권위와 정통성을 드러내는 중요한 요소였어요. 이제 이런 배경지식을 바탕으로 실제로 광화문을 한번 자세히 살펴보시죠!"
...

{
  "chapter": {
    "id": ${chapterIndex},
    "title": "${chapterTitle}",
    "narrative": "이 부분에 1500-1700자의 상세하고 흥미진진한 오디오 가이드 스크립트를 작성하세요. 현장 묘사부터 시작해서 역사적 배경, 관련 인물들의 이야기, 그리고 다음 장소로의 자연스러운 연결까지 하나의 연속된 이야기로 만들어주세요. 실제 관광 가이드가 현장에서 관광객들에게 들려주는 것처럼 구어체로 친근하게 작성하고, 중간중간 '여기서 주목할 점은', '흥미로운 사실은', '이야기를 들어보면' 같은 자연스러운 연결 표현을 넣어서 생동감 있게 만들어주세요.",
