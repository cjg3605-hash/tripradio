      ...
      chapters: [
        {
          ...
          coreNarrative: "이 장소는 태종 시대에 처음 건립되었지만, 현재 모습은 세종대왕 때 완성된 것입니다. 당시 사람들이 이곳을 '하늘과 땅이 만나는 신성한 공간'으로 여긴 이유는 왕의 덕치를 상징하는 공간이었기 때문이에요. 임진왜란과 일제강점기를 겪으면서 많은 시련을 겪었지만, 꿋꿋이 그 가치를 지켜온 것이죠. 특히 1950년대 복원 과정에서 정말 감동적인 사람들의 이야기가 숨어 있다는 걸 아시나요?",
          
          humanStories: "1950년대 복원 공사 당시 문화재 전문가 황수영 박사가 조선왕조실록의 기록을 바탕으로 원형을 복원하는 과정은 정말 감동적이었어요. 밤낮없이 연구하며 정확한 치수와 기법을 찾아낸 그의 노력이 있었기에 오늘날의 모습이 가능했답니다. 또한 복원에 참여한 전통 목수 장인들도 조선시대 전통 기법을 현대에 되살리기 위해 몇 년간 연구하고 실험한 그들의 정성이 담긴 이야기로 많은 사람들에게 감동과 교훈을 주고 있어요.",
...
### 4. **최소 분량 (한국어 기준)**
- sceneDescription: 600자 이상 (현장 생생한 묘사)
- coreNarrative: 500자 이상 (역사적 사실과 의미)
- humanStories: 250자 이상 (핵심 인물 이야기)
- nextDirection: 150자 이상 (구체적 경로 안내)
...
1. **현장 묘사** (550-600자): 방문객이 실제로 보고 느낄 수 있는 생생한 장면
2. **역사적 배경** (450-500자): 이 장소의 역사, 건축적 특징, 문화적 의미
3. **인물 이야기** (200-250자): 실제 역사적 인물이나 검증된 일화
4. **다음 이동 안내** (100-150자): 구체적인 경로와 다음 장소 예고
