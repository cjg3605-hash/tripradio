...
4. **풍부하고 교육적인 내용 (각 섹션 최소 분량)**
   - sceneDescription: 800자 이상 (약 3분) - 사전지식 설명 + 현장 관찰 유도
   - coreNarrative: 1000자 이상 (약 4분) - 역사적 맥락과 의미, 특징과 지식 연결
   - humanStories: 900자 이상 (약 3분 30초) - 실제 역사적 인물이나 검증된 일화
   - nextDirection: 400자 이상 (약 1분 30초) - 다음 장소 안내와 기대감 조성
   - **총 12-13분의 깊이있는 교육적 오디오**
