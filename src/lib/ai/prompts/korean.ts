...
// 오디오 가이드 예시 - 자연스럽게 이어지는 구조 (구체적 실용 예시)
      ...
      chapters: [
        {
          ...
          // 아래 4개 필드가 하나의 자연스러운 12-13분 오디오 스크립트를 구성합니다
...
**🎯 중요한 제목 형식: "구체적 장소명 - 그 장소의 특징/의미"**

**✅ 올바른 제목 예시:**
- **박물관**: "선사·고대관 - 한반도 최초 문명의 흔적"
- **궁궐**: "광화문 - 조선 왕조 500년의 정문"  
- **성당**: "중앙 신도석 - 천상을 향한 기도의 공간"
- **자연**: "전망대 - 파노라마로 펼쳐지는 절경"
- **전통마을**: "종가댁 - 조선시대 양반가의 생활상"
- **맛집거리**: "할머니국수집 - 50년 전통의 손맛"

**❌ 잘못된 제목 예시:**
- "첫 번째 관람구역", "역사와 문화의 만남", "웅장한 건축물과 상징물"
...
**🚨 sceneDescription 시작 방법 - 매우 중요! 🚨**
- ❌ 절대 금지: "이곳에서 가장 먼저...", "여기서 눈에 들어오는...", "지금 우리가 서 있는 이곳...", "바로 앞에 보이는..." 등
- ✅ 올바른 시작: 바로 장소명으로 직접 시작
  
**예시:**
❌ "지금 우리가 서 있는 이곳, 경회루는..."
✅ "경회루는 경복궁에서도 손꼽히는 아름다운 건축물로..."

❌ "이곳에서 가장 먼저 눈에 들어오는 것은 바로 불국사의..."  
✅ "불국사는 신라 불교 예술의 정수를 보여주는..."
...
**✅ 범용 교육적 구조 예시 (장소명으로 바로 시작→현장연결→심화이해)**:
- sceneDescription: "[장소명]은 [기본 정의나 성격]으로, [해당 분야의 기본 개념]은 단순한 [표면적 이해]가 아니라 [깊은 의미나 철학]을 담은 [중요한 요소]였습니다. 특히 [핵심 특징이나 이름]은 [의미 설명]으로, [역사적/문화적 맥락]을 표현한 거죠. 또한 [관련 요소들]은 [그 시대나 지역의 특성]을 드러내는 중요한 증거였어요. 이제 이런 배경지식을 바탕으로 실제로 [장소명]을 한번 자세히 살펴보시죠!"
...
🚨 **절대 중요 - 완전한 내용 필수**
- narrative 필드에 **최소 1800-2000자의 완전한 내용** 작성 (절대 짧게 쓰지 마세요!)
- 현장 묘사 + 역사적 배경 + 인물 이야기 + 문화적 의미를 **하나의 자연스러운 스토리**로 통합
...
3. **인물 이야기** (400-500자): 실제 역사적 인물이나 검증된 일화
4. **다음 이동 안내** (200-300자): 구체적인 경로와 다음 장소 예고
...
- 짧고 대충 쓰기 금지 - **반드시 1800-2000자의 풍부한 내용**
