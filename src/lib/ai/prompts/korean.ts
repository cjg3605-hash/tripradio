...

{
  "chapter": {
    "id": ${chapterIndex},
    "title": "${chapterTitle}",
    "narrative": "이곳에서 가장 먼저 눈에 들어오는 것은... [현장의 생생한 묘사를 550-600자로 자세히 작성] ...그런데 이 장소가 왜 이렇게 특별할까요? 바로 [시기]에 [역사적 배경과 의미를 450-500자로 상세히 설명] ...이런 역사 속에는 정말 감동적인 인물들의 이야기가 있습니다. [실제 역사적 인물이나 검증된 일화를 200-250자로 풍부하게 서술] ...자, 이런 의미 깊은 이야기를 마음에 새기며 이제 다음 지점으로 이동해보겠습니다. [구체적인 이동 경로와 다음 장소 예고를 100-150자로] (총 1400-1500자의 완전한 스토리)",
