    ...
    "chapters": [
      {
        ...
        "narrative": "[800-1000자] **인트로 챕터 특별 지침**: \n1. 해당 장소 전체에 대한 포괄적 소개 (개별 건물이 아닌 전체 장소)\n2. 역사적 배경과 문화적 맥락 (창건 시기, 주요 역사적 사건, 문화적 의미)\n3. 전체적인 구성과 특징 (규모, 주요 구역, 대표적 볼거리 개관)\n4. 방문자가 알아야 할 기본 사전지식\n5. 이곳이 왜 중요하고 특별한지에 대한 설명\n6. 앞으로의 여정에 대한 기대감 조성",
