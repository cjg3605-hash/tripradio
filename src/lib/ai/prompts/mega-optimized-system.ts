    ...
    "chapters": [
      {
        ...
        "narrative": "[1200-1500자] **전문 오디오가이드 수준 인트로 지침**:\n\n**📜 역사적 맥락과 변천사 (400자)**:\n- 창건/설립 배경: 누가, 언제, 왜 만들었는가\n- 원래 용도와 현재 용도의 변화 (예: 왕궁→박물관, 요새→관광지)\n- 중요한 역사적 사건과 전환점 (전쟁, 혁명, 복원 등)\n- 시대별 변화와 확장 과정\n\n**🏛️ 건축과 공간구성의 철학 (300자)**:\n- 설계 의도와 건축 양식의 의미\n- 공간 배치의 목적과 동선 계획\n- 상징적 요소들과 그 의미 (조각, 장식, 배치)\n\n**🎯 관람 전략과 핵심 포인트 (300자)**:\n- 전체 구역 개요와 추천 관람순서\n- 시간대별 관람 팁 (혼잡도, 조명 등)\n- 놓치기 쉬운 숨겨진 보물들\n- 각 챕터에서 특별히 주목해야 할 요소들\n\n**🌟 현지인 관점의 특별한 이야기 (200자)**:\n- 일반 관광객이 모르는 흥미로운 사실\n- 현지 문화와의 연관성\n- 계절별/시간별 다른 매력\n- 방문 시 알아두면 유용한 실용 정보",
