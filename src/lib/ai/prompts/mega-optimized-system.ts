    ...
    "chapters": [
      {
        ...
        "narrative": "🎯 인트로 챕터 특수 생성 규칙 적용:\n1. **전체 장소 포괄적 소개**: ${locationName} 전체에 대한 역사적 배경, 문화적 맥락, 전체 구성 및 의미 (개별 건물이 아닌 전체 장소 중심)\n2. 감정적 몰입 유도 오프닝 (${Math.round(expert.verified_patterns.emotional_engagement * 100)}%)\n3. ${expert.tone} 톤으로 해당 지역/문명의 역사적 배경과 사전지식 설명\n4. ${expert.cultural_wisdom[0]}\n5. 전체적인 규모, 주요 구역, 대표적 볼거리 개관\n6. 방문자가 알아야 할 기본 사전지식 제공\n7. 이곳이 왜 중요하고 특별한지에 대한 설명\n8. 앞으로의 여정에 대한 기대감 조성과 자연스러운 연결",
...
## 🎯 인트로 챕터(ID=0) 특별 생성 지침 (96.3% 만족도 최적화)
**인트로 챕터는 전체 투어의 첫인상을 결정하는 핵심 요소이며, 개별 건물이 아닌 해당 장소 전체에 대한 포괄적 소개와 배경지식을 제공합니다.**

### 🚨 핵심 원칙: **전체 장소 중심의 포괄적 소개**
- ❌ 광화문의 건축 특징만 설명 (개별 건물 중심)
- ✅ 경복궁 전체의 역사, 의미, 구성, 문화적 맥락 설명 (전체 장소 중심)

### 필수 구성 요소 (${expert.expertise} 전문성 반영):
1. **전체 장소 포괄적 소개**: 해당 장소 전체에 대한 역사적 배경, 창건 시기, 주요 역사적 사건
2. **문화적 맥락과 사전지식**: ${expert.tone} 톤으로 해당 지역/문명의 문화적 배경과 방문자가 알아야 할 기본 지식
3. **전체 구성과 규모**: 전체적인 구조, 주요 구역, 대표적 볼거리 개관
4. **역사적 의미와 가치**: 이곳이 왜 중요하고 특별한지에 대한 설명
5. **구체적 사실**: 연도, 수치, 인명 등 검증 가능한 팩트 최소 5개 포함 (전체 장소 관련)
6. **감정적 몰입 오프닝**: 시간이 멈춘 듯한 순간/경외감을 느낄 수 있는 표현으로 시작
7. **개인적 연결**: 방문자 각자의 발견과 감동 유도
8. **여정 기대감**: 앞으로의 여정에 대한 기대감 조성과 첫 번째 핵심 공간으로의 자연스러운 연결

### 위치별 전용 톤 적용:
- **궁궐/왕궁**: 권위와 품격, 정치적 상징성 강조
- **종교건축**: 영성과 신앙, 초월적 경험 유도  
- **고대유적**: 시간의 깊이와 인류 문명의 위대함
- **자연명소**: 자연과의 교감, 장관의 압도적 경험
- **근현대건축**: 혁신과 진보, 시대정신의 구현
