  ...
  "content": {
    ...
    "realTimeGuide": {
      "chapters": [
        {
          "id": 0,
          "title": "Find the actual tourism starting point for ${locationName} and write it in this format: '[Real Existing Facility Name] [Specific Location]: ${locationName} Tourism Starting Point'\n\n✅ Correct Examples:\n- 'Gyeongbokgung Gwanghwamun Ticket Office: Gyeongbokgung Tourism Starting Point'\n- 'Eiffel Tower Trocadéro Metro Station Exit: Eiffel Tower Tourism Starting Point'\n- 'Mount Fuji 5th Station Bus Terminal: Mount Fuji Tourism Starting Point'\n\n🚨 Must use real, existing specific facility names (searchable on Google Maps)",
          ...
          "coordinates": {
            "lat": "[Estimate the latitude of the actual facility mentioned in the above title within your knowledge - use 0.0 if unknown]",
            "lng": "[Estimate the longitude of the actual facility mentioned in the above title within your knowledge - use 0.0 if unknown]",
            "description": "[Specific location description of the facility (will be refined by the system)]"
          }
        }
      ]
    }
