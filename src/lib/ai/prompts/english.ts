  ...
  "content": {
    ...
    "realTimeGuide": {
      "chapters": [
        {
          "id": 0,
          "title": "🎯 Google Places API Optimization: Write ONLY the specific facility name for ${locationName} tourism (NO descriptions)\n\n✅ Correct Examples:\n- Gwanghwamun Ticket Office\n- Trocadéro Metro Station\n- 5th Station Bus Terminal\n- Westminster Abbey Great West Door\n- Louvre Pyramid Entrance\n\n❌ Wrong Examples:\n- Gwanghwamun Ticket Office: Gyeongbokgung Tourism Starting Point\n- Trocadéro Metro Station: Eiffel Tower Tour Beginning\n\n✅ Essential: Google Maps searchable facility names only",
