      ...
      "chapters": [
        {
          ...
          "humanStories": "昭和20年の終戦直後、食糧難の時代に起こった出来事です。当時の住職だった橋本静雄師は、参拝に来る人々が皆やつれているのを見て、境内で野菜を育てて無償で配り始めました。仁王門の脇には今でも小さな畑の跡が残っていますが、そこで育てた大根や白菜を、この門の下で毎朝配っていたのです。「仁王様のお野菜」と呼ばれて親しまれ、多くの人々の命を救いました。仁王門は単なる建築物ではなく、人々の心を繋ぐ場所でもあったのです。",
          "nextDirection": "仁王門をくぐって参道を約50メートル進んでください。石段を上がりながら、両側に並ぶ石灯籠と、徐々に姿を現す本堂の屋根に注目してください。次は清水寺のハイライト、本堂の清水の舞台へとご案内いたします。"
        }
      ]
    }
  }
...
- 短く適当に書くことを禁止 - **必ず1600-1800文字の豊富な内容**
...
🚨 絶対遵守要項 🚨
- **narrativeフィールドは必ず1800-2000文字（最低1800文字！）**
- 序文や説明なしで直接JSONを開始
- コードブロック表示絶対禁止  
- 文法的に完璧なJSON形式
