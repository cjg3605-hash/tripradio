  ...
  "content": {
    ...
    "realTimeGuide": {
      "chapters": [
        {
          "id": 0,
          "title": "Encuentra el punto de inicio real de turismo para ${locationName} y escríbelo en este formato: '[Nombre de Instalación Real Existente] [Ubicación Específica]: ${locationName} Punto de Partida Turístico'\n\n✅ Ejemplos Correctos:\n- 'Real Alcázar Puerta del León Taquilla: Real Alcázar Punto de Partida Turístico'\n- 'Torre Eiffel Estación Metro Trocadéro Salida: Torre Eiffel Punto de Partida Turístico'\n- 'Monte Fuji Terminal de Autobuses 5ta Estación: Monte Fuji Punto de Partida Turístico'\n\n🚨 Debe usar nombres específicos de instalaciones reales existentes (que se puedan buscar en Google Maps)",
          ...
          "coordinates": {
            "lat": "[Estimar la latitud de la instalación real mencionada en el título anterior dentro de tu conocimiento - usar 0.0 si no lo sabes]",
            "lng": "[Estimar la longitud de la instalación real mencionada en el título anterior dentro de tu conocimiento - usar 0.0 si no lo sabes]",
            "description": "[Descripción específica de ubicación de la instalación (será refinado por el sistema)]"
          }
        },
        {
          "id": 1,
