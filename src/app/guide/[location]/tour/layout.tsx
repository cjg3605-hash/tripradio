...
export async function generateMetadata({ params }: { params: Promise<{ location: string }> }): Promise<Metadata> {
  ...
  const templates = {
    ko: {
      title: `${locationName} 실시간 투어 가이드 - NaviDocent AI`,
    ...
    en: {
      title: `${locationName} Real-time Tour Guide - NaviDocent AI`,
    ...
    ja: {
      title: `${locationName}リアルタイムツアーガイド - NaviDocent AI`,
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: `${locationName} Real-time Tour Guide - NaviDocent AI`
        }
      ]
    },
    twitter: {
