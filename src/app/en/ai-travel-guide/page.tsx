                  ...
                  <div>
                    ...
                    <div className="bg-gray-50 p-4 rounded-lg">
                      <p className="text-sm text-gray-700">
                        💡 Example: &ldquo;Paris, France&rdquo; or &ldquo;Hidden temples in Kyoto&rdquo;
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <div className="bg-white p-8 rounded-lg border border-gray-200">
              ...
              <p className="text-gray-600 mb-6 italic leading-relaxed">
                &ldquo;The AI found authentic local restaurants in Tokyo that I never would have discovered. It felt like having a local friend guide me!&rdquo;
              </p>
            ...
            <div className="bg-white p-8 rounded-lg border border-gray-200">
              ...
              <p className="text-gray-600 mb-6 italic leading-relaxed">
                &ldquo;Perfect for my art history trip to Rome. The AI knew exactly which museums and hidden galleries matched my interests.&rdquo;
              </p>
            ...
            <div className="bg-white p-8 rounded-lg border border-gray-200">
              <div className="text-4xl mb-6 text-center">🌍</div>
              <p className="text-gray-600 mb-6 italic leading-relaxed">
                &ldquo;Saved me hours of planning time and gave me experiences I could never have planned myself. This is the future of travel!&rdquo;
              </p>
