...
const kv = {
  ...
  setex: async (key: string, seconds: number, value: unknown): Promise<'OK'> => {
...
// Use Node.js runtime for better compatibility with NextAuth
...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    console.log('🔍 자동완성 API 요청 받음:', { query, language, url: request.url });
