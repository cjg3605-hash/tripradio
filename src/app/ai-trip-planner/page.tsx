  ...
  const travelStyles: TravelStyle[] = [
    {
      ...
      focus: [
        t('tripPlanner.data.travelStyles.solo.focus.freedom') || '자유도',
        t('tripPlanner.data.travelStyles.solo.focus.growth') || '개인 성장',
        t('tripPlanner.data.travelStyles.solo.focus.experience') || '새로운 경험'
      ]
    },
    {
      id: 'couple',
      ...
      focus: [
        t('tripPlanner.data.travelStyles.couple.focus.romantic') || '로맨틱',
        t('tripPlanner.data.travelStyles.couple.focus.rest') || '휴식',
        t('tripPlanner.data.travelStyles.couple.focus.memories') || '추억 만들기'
      ]
    },
    {
      id: 'family',
      ...
      focus: [
        t('tripPlanner.data.travelStyles.family.focus.safety') || '안전',
        t('tripPlanner.data.travelStyles.family.focus.facilities') || '편의시설',
        t('tripPlanner.data.travelStyles.family.focus.kidFriendly') || '아이 친화적'
      ]
    },
    {
      id: 'friends',
      ...
      focus: [
        t('tripPlanner.data.travelStyles.friends.focus.activities') || '액티비티',
        t('tripPlanner.data.travelStyles.friends.focus.nightlife') || '나이트라이프',
        t('tripPlanner.data.travelStyles.friends.focus.groupDiscount') || '그룹 할인'
      ]
    },
    {
      id: 'workation',
      ...
      focus: [
        t('tripPlanner.data.travelStyles.business.focus.wifi') || 'WiFi',
        t('tripPlanner.data.travelStyles.business.focus.cafe') || '카페',
        t('tripPlanner.data.travelStyles.business.focus.workEnvironment') || '업무 환경'
      ]
    }
  ];
