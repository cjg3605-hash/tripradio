    ...
    return (
      <div className="h-full flex flex-col items-center justify-center p-8 bg-background">
        <div className="text-center space-y-8 max-w-sm">
          <div className="w-40 h-40 border-4 border-border rounded-3xl flex items-center justify-center mx-auto bg-muted/20">
            <BookOpen className="w-20 h-20 text-muted-foreground" />
          </div>
          <div>
            <h2 className="text-2xl font-bold mb-3 text-foreground">가이드를 선택하세요</h2>
            <p className="text-muted-foreground leading-relaxed">여행지를 검색하여 AI 가이드를 생성해보세요</p>
          </div>
          <button 
            onClick={() => setCurrentScreen('home')}
            className="w-full py-4 px-6 bg-foreground text-background hover:bg-foreground/90 rounded-2xl font-semibold transition-all duration-200 hover:scale-[1.02] active:scale-[0.98]"
          >
            홈으로 돌아가기
          </button>
        </div>
      ...
      <div className="p-6 border-b border-border/50">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            <button 
              onClick={() => setCurrentScreen('home')}
              className="w-10 h-10 border border-border rounded-2xl flex items-center justify-center hover:border-foreground transition-colors"
            >
              <ArrowLeft className="w-5 h-5" />
            </button>
            <div>
              <h1 className="font-bold text-lg text-foreground">여행 가이드</h1>
              <p className="text-sm text-muted-foreground">AI 맞춤형 가이드</p>
            </div>
          </div>
          <div className="flex gap-2">
            <button className="w-10 h-10 border border-border rounded-2xl flex items-center justify-center hover:border-foreground transition-colors">
